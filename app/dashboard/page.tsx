  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <a href="https://ko-fi.com/S6S61YLYW1" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full flex items-center justify-center text-sm hover:scale-110 transition-all" style={{ background: 'rgba(255,255,255,0.04)' }} title="Support StoryMiles">☕</a>
